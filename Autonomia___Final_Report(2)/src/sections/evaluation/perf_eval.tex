\hmsubsection{Performance Evaluation}{}{}\label{sec:performance-evaluation}
...
described in Section~\ref{sec:sag}, the sag model is not exercised in
...
\hmsubsubsection{Integrated MVP Timing}{UMA}{}

The final MVP validation session, summarised in
Table~\ref{tab:mvp-final-timing}, also provided timing data for
20 complete scan-pick-place cycles. The average total cycle time
was 12.75~s, with a minimum of 12.13~s and a maximum of 16.68~s,
corresponding to approximately 4.7~balls/min for this validation
session. The phase averages were 3.11~s for scan, 1.67~s for
approach, 1.54~s for grab, 2.78~s for sort movement, and 3.64~s
for drop. The maximum scan time of 5.83~s and maximum grab time
of 2.89~s include the retry-recovered cycle~7 event and therefore
should not be interpreted as standalone evidence of general
instability. The final session still completed 20/20 balls sorted
correctly (100\% observed net sorting success) with 0 unrecovered
failures.
