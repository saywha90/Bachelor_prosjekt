...
The system developed in this project follows this principle. The 
camera mounted on the wrist acts as the sensor, observing the 
workspace and the objects placed within it. The host processor 
analyses the resulting image data to identify the colour and 
position of each object. The robotic arm then translates this 
decision into motion, transporting each object to the bin that 
corresponds to its detected colour. The cycle repeats 
continuously while objects remain in the workspace.
