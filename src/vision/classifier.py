...
def _extract_hsv_histogram(img_bgr: np.ndarray) -> np.ndarray:
    ...
    def _hist(channel: np.ndarray, bins: int, lo: int, hi: int) -> np.ndarray:
        """Compute a normalised histogram for one HSV channel region."""
...
class ColorHistogramClassifier:
    ...
    def __init__(self, model_path: str = "models/ball_color_classifier.pkl") -> None:
        """
