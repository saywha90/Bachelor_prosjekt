...
**Files:** `src/vision/enhanced_detector.py`, `src/IK/vision_bridge.py`
...
**Files:** `src/vision/enhanced_detector.py`, `src/vision/config.py`
...
**Files:** `src/IK/vision_bridge.py`, `src/IK/main.py`
