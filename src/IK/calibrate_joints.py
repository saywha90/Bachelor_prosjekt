...
def test_5_known_geometry():
    ...
    print()
    print("Expected claw tip position (if L1=25.5, L2=23.0, L3=16.5,")
    print("shoulder_height=33.0):")
    print("    x = L1 = 25.5 cm")
    print("    y = 0")
    print("    z = shoulder_height - L2 - L3 = 33 - 23 - 16.5 = -6.5 cm")
    print("    (i.e. the claw tip would be 6.5 cm BELOW the desk;")
...
def main():
    ...
    print("them to fix the sign/zero errors in pi_kinematics.py.")
    print()
    ...
    print("exactly which lines in pi_kinematics.py to change.")
    print("=" * 60)
