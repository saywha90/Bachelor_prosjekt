...
The workspace bins from ``config.py`` are drawn as coloured markers so
...
from config import BINS, HOME_POSITION
...
class ArmVisualizer:
    ...
    def close(self):
        ...
        plt.ioff()
        print("\n[VISUALIZER] 🖼️   Simulation complete — close the plot window to exit.")
        plt.show()
