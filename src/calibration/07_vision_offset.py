...
-----
    ...
    4. Compare to your physical measurement and adjust src/config/arm.py.
...
def main():
    ...
    print("║  3. Adjust CAMERA_OFFSET_X/Y in src/config/arm.py until they match ║")
    print("║                                                            ║")
    ...
    print("  To adjust the offset, edit src/config/arm.py:")
